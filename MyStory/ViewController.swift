...
class ViewController: UIViewController {
    ...
    let aboutMe = ContextItem(title: "About Me", image: UIImage(named: "family")!, text: "Hello! I'm Nezuko Kamado. I'm the second oldest of 5 siblings. I used to live on the mountain until my family was attacked and killed by a demon. My brother and I were the only survivors, but I turned into a demon. Now, I travel alongside him as a Demon Slayer protecting humans while he looks for a way to turn me human again :)")
    let abilities = ContextItem(title: "Abilities", image: UIImage(named: "demon")!, text: "Some of my ablities as a demon are immense regeneration, immense strength, size alteration, blood manipulation, and sunlight resistance. Yay!")
